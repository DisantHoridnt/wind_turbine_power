...
from .model.data import DataProcessor as data_processor
from os import path
import numpy as np
...
def main():
    ...
    if args.command == 'generate_data':
        try:
            data, power_outputs = data_processor.generate_turbine_data(int(args.size), args.cut_in, args.rated_speed, args.rated_power, args.cut_out, args.shape, args.scale, args.random_seed)
