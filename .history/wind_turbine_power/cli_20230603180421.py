...
def main():
    ...
    if args.command == 'generate_data':
        try:
            data, power_outputs = data_processor.generate_turbine_data(args.size, args.min_speed, args.max_speed, rated_power=args.power_coeff, cut_out=args.std_dev, shape=args.shape, scale=args.scale, wind_direction_range=args.wind_direction_range, temperature_range=args.temperature_range)
