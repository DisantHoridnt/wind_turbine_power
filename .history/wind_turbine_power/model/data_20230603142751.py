...
class DataProcessor:
    ...
    def generate_turbine_data(self, num_samples, cut_in, rated_speed, rated_power, cut_out, shape=2, scale=15, random_state=None):
        ...
        for i, speed in enumerate(wind_speeds):
            ...
            power += max(np.random.normal(0, power * 0.05), 0)  # add some noise
