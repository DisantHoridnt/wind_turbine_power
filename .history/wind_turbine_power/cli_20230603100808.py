...
def main():
    ...
    try:
        wind_speeds, power_outputs = data_processor.generate_turbine_data(args.size, args.min_speed, args.max_speed, args.std_dev, args.power_coeff, args.shape, args.scale)
