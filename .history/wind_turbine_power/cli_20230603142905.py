...
def main():
    ...
    data_processor = DataProcessor()  # create an instance of DataProcessor here

    if args.command == 'generate_data':
        try:
            wind_speeds, power_outputs = data_processor.generate_turbine_data(args.size, args.min_speed, args.max_speed, rated_power=args.power_coeff, cut_out=args.std_dev, shape=args.shape, scale=args.scale)
