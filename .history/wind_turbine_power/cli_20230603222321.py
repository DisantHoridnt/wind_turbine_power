...
from .model.data import DataProcessor  # import DataProcessor here
from os import path
import numpy as np
...
def main():
    ...
    if args.command == 'generate_data':
        try:
            data, power_outputs = turbine_model.data_processor.generate_turbine_data(args.size, args.cut_in, args.rated_speed, args.rated_power, args.cut_out, args.shape, args.scale)
